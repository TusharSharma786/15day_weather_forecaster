...
import ForecastImageDetail from '../forecast-image-detail.component';
...
it('renders the ouput in UI',()=>{
    ...
    const { getByText } = render(<ForecastImageDetail image={image4} data = {responseData}/>,div);
    ...
    expect(getByText("Wind speed- 3mph south-southwest")).toBeTruthy();
})